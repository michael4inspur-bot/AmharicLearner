...
**Goal:** 把 AmharicLeander 的 Express 后台替换为一个微信云函数 `api` 加两个云数据库集合，小程序改用 `wx.cloud.callFunction`，删除 `server/`。
...
```json
{
  "name": "api",
  "version": "1.0.0",
  "description": "AmharicLeander 云函数：进度存储 + DeepSeek 学习诊断",
  "main": "index.js",
  "scripts": {
...
```json
{
  ...
  "private": true,
  "description": "AmharicLeander 阿姆哈拉语学习小程序（含微信云函数）",
  "scripts": {
