...
export function diagnosisSystemPrompt() {
...
export function planAdjustSystemPrompt() {
...
export function tutorSystemPrompt(summary) {
...
export function buildDiagnosisUserMessage(summary, planOutline) {
  return [
    '以下是学员的学习数据，请做出诊断。',
    '',
    '## 学习计划大纲',
...
export function buildPlanAdjustUserMessage(summary, planOutline, diagnosis, request) {
  return [
    '请根据以下信息修改学习计划。',
    '',
    '## 当前学习计划大纲',
